...
class AdminRoleManage(Command):
    ...
    def execute(self, opts, args):
       ...
       # Check arguments
        ...
        if (opts.set_users and opts.roles == None) or (opts.set_users == None and opts.roles):
        ...
        # set_users
            ...
            _exitIfErrors(errors)
            print "SUCCESS: set roles for ", opts.set_users, ". New user/role list:"
        ...
        # delete_users
            ...
            _exitIfErrors(errors)
            print "SUCCESS: removed users ", opts.delete_users, ". New user/role list:"
